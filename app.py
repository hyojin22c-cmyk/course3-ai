...
TRACK_UNIV_GUIDE = {
    "이공계 (공학·반도체·전기전자·기계)": {
        "icon": "⚙️",
        "prereq": "서울대·고려대 등은 2학년에서 <b>기하 + 미적분Ⅱ</b>, 과학 진로선택(역학과 에너지, 전자기와 양자 등) <b>2~3과목 이상</b> 이수를 권장합니다. 숙명여대·동국대도 수학·과학을 1단계(최고 관련성) 교과영역으로 지정하고 있어요.",
        "third": "3학년에서는 <b>고급 물리학, 고급 미적분, 물리학 실험, 데이터 과학</b> 등으로 심화 이수를 보여주세요. 경희대는 수학 5과목·과학 6과목 이상 이수 시 가산점도 있어요.",
    },
    "IT·컴퓨터·AI": {
        "icon": "💻",
        "prereq": "이공계와 동일하게 <b>기하 + 미적분Ⅱ</b> 이수가 권장돼요. 숙명여대 수학/컴퓨터 범주에서는 수학·과학·정보를 모두 1단계 교과영역으로 제시합니다.",
        "third": "3학년에서는 <b>데이터 과학, 고급 대수, 고급 미적분</b>을 통해 수학+정보 역량을 동시에 보여주세요. 숙명여대는 정보 교과(인공지능 기초, 데이터 과학)도 핵심 권장 과목이에요.",
    },
    "의약계 (의대·치대·한의대·약대·수의대)": {
        "icon": "🏥",
        "prereq": "서울대 의대는 <b>기하 + 미적분Ⅱ</b> + <b>세포와 물질대사, 생물의 유전 포함</b> 과학 진로선택 3과목 이상을 권장합니다. 숙명여대 약학부도 화학·생명과학을 1단계로 지정해요.",
        "third": "3학년에서는 <b>고급 생명과학 + 생명과학 실험</b>, <b>고급 화학 + 화학 실험</b> 조합으로 이론+탐구 역량을 모두 보여주세요. 숙명여대 약학부는 영어 능력도 준비사항으로 강조하니 <b>영어 심화 과목</b>도 고려해보세요.",
    },
    "보건·간호": {
        "icon": "💊",
    ...
    "자연과학 (수학·물리·화학·생명·지구과학)": {
        "icon": "🔬",
        "prereq": "자연과학대 지원 시 <b>기하 + 미적분Ⅱ</b> + 해당 분야 과학 진로선택 이수가 기본이에요. 숙명여대 화학·생명시스템학부는 화학·생명과학을 1단계로, 수학을 2단계로 지정합니다.",
        "third": "3학년에서는 <b>고급 물리학/화학/생명과학 + 실험 과목 + 수학과제 탐구</b>로 깊이 있는 이수 이력을 만들어주세요.",
    },
    "인문·사회 (인문학·사회학·심리학)": {
        "icon": "📖",
        "prereq": "서울대는 <b>제2외국어/한문 1과목 이상</b> 이수를 권장해요. 동국대·숙명여대는 인문계열에서도 <b>국어·영어·사회</b>를 1단계 교과영역으로 구체적으로 지정하고 있어요.",
    ...
    "법·정치·행정": {
        ...
        "third": "3학년에서 <b>정치, 법과 사회, 국제 관계의 이해</b> 등 사회 교과 심화를 집중 이수하고, <b>데이터 과학</b>도 숙명여대 사회과학 범주에서 진로선택 관련 교과로 제시하고 있어요.",
    },
    "상경계 (경영·경제·금융·회계)": {
        "icon": "📊",
        "prereq": "부산대 경제학부 등은 <b>확률과 통계, 미적분Ⅰ, 미적분Ⅱ 중 1과목 이상</b> 이수를 권장합니다. 숙명여대 경영·경제 범주는 <b>수학·영어</b>를 1단계, <b>사회</b>를 2단계 교과영역으로 지정해요.",
        "third": "3학년에서는 <b>경제 수학, 금융과 경제 생활, 데이터 과학</b>으로 수학+경제+정보 융합 역량을 보여주세요. 숙명여대는 정보 교과(데이터 과학)를 경영·경제 범주 진로선택으로도 제시합니다.",
    },
    "교육 (사범대·교직)": {
        "icon": "🎓",
        "prereq": "사범대는 계열에 따라 달라요. 숙명여대 교육학부는 <b>국어·영어·사회</b>를 1단계, <b>수학</b>을 3단계 교과영역으로 지정합니다.",
        "third": "3학년에서 <b>교육의 이해</b>로 교육학 관심을 보여주고, 전공 교과(국어/영어/수학/과학 등) 심화 과목을 함께 이수하세요. 숙명여대는 <b>정보 교과(데이터 과학)</b>도 교육 범주 진로선택으로 제시해요.",
    },
    "어문·외국어 (영문·국문·통번역)": {
        "icon": "🌐",
        "prereq": "서울대 <b>제2외국어/한문 1과목 이상</b> 이수 권장. 숙명여대 언어·문학 범주는 <b>국어·영어</b>를 1단계, <b>사회·제2외국어</b>를 2~3단계 교과영역으로 지정합니다.",
        "third": "3학년에서 <b>심화 영어, 영어 발표와 토론, 화법과 언어, 문학 감상과 비평</b> 등 국어·영어 심화를 깊이 있게, <b>일본/중국 문화 → 심화 일본어/중국어</b>로 제2외국어도 챙기세요.",
    },
    "국제·외교 (국제학·외교·국제기구)": {
        "icon": "🌍",
        "prereq": "서울대 <b>제2외국어/한문 1과목 이상</b> 권장. 숙명여대 글로벌협력전공은 <b>영어·사회</b>를 핵심 교과로, 동국대도 영어·사회를 역량 영역으로 제시합니다.",
        "third": "3학년에서 <b>국제 관계의 이해, 심화 영어/중국어, 기후변화와 지속가능한 세계</b> 등으로 글로벌 이슈+외국어 역량을 동시에 보여주세요.",
    },
    "환경·도시·건축": {
        "icon": "🏗️",
        "prereq": "건축·환경공학은 이공계와 유사하게 <b>기하 + 미적분Ⅱ</b>, 물리·화학 진로선택 이수가 권장돼요. 숙명여대 환경디자인과는 사회+과학 융합적 시각을 강조합니다.",
        "third": "3학년에서 <b>도시의 미래 탐구, 기후변화와 환경생태</b> + 물리/화학 심화로 사회+과학 융합 시각을 보여주세요.",
    },
    "미디어·언론·광고": {
        "icon": "📺",
        "prereq": "숙명여대 미디어학부·홍보광고학과는 <b>국어·영어·사회</b>를 1단계 교과영역으로 지정해요. 동국대도 국어·사회를 역량 영역으로 강조합니다.",
        "third": "3학년에서 <b>미디어 영어, 화법과 언어, 사회문제 탐구</b> 등으로 미디어+사회 교과 연계를 보여주세요. <b>데이터 과학</b>도 숙명여대 경영·경제 범주에서 미디어 마케팅과 연결되는 역량이에요.",
    },
    "관광·호텔·항공": {
        "icon": "✈️",
